        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              Más que parcelas, construimos historias.
            </p>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              <a href="https://www.instagram.com/ichicureo.cl/" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.facebook.com/profile.php?id=61553161647632" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.youtube.com/@inmobiliariachicureo8214" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-3">
              <a href="https://wa.me/56932327156" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-white/90 hover:text-white transition">
              ...
              <a href="mailto:contacto@inmobiliariachicureo.cl" className="flex items-center gap-2 text-sm text-white/90 hover:text-white transition">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>contacto@inmobiliariachicureo.cl</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-6 lg:px-8 py-6">
          <p className="text-white/50 text-xs text-center">
            © 2026 Inmobiliaria Chicureo. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
